...
export default function Home() {
  ...
  return (
    <>
      <div className="modal login-modal" id="login-modal" tabIndex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
        <div className="modal-dialog login-dialog">
          <div className="loginmodal-container">
            ...
            <form>
              ...
              <input type="submit" onClick={login} name="login" className="login loginmodal-submit" value="Login" />
            </form>
